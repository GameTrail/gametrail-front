const nextConfig = {
  ...
  images: {
    ...
    domains: ['c4.wallpaperflare.com', 'vignette4.wikia.nocookie.net',
      ...
      'i.imgur.com', 'cdnb.artstation.com', 'upload.wikimedia.org', 'via.placeholder.com', 'store-images.s-microsoft.com', 'img.lovepik.com', 'cdn.pixabay.com', 'images.igdb.com', 'cdn.cloudflare.steamstatic.com'],
  },
};
