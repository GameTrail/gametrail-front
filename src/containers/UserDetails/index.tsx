...
import { UserData, UserStats, UserGameList, UserTrailList, UserAverageRating, UserListsButtons } from '@/components/UserDetails';
import type { UserDetails as UserDetailsProps } from '@/models/User/types';
import { Container, InfoDetails, StatsDetails, ListsDetails } from './styles';
