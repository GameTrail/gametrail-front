...
const Home = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      const urls = ['https://gametrail-backend-s4-production.up.railway.app/api/getTrail/17', 'https://gametrail-backend-s4-production.up.railway.app/api/recentGames/', 'https://gametrail-backend-s4-production.up.railway.app/api/sabiasque/'];
